...
HD_PWD='D:/Instrumentacion/Boris FPGA/Unidad_Conteo_Coincidencias/Unidad_Conteo_Coincidencias.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UCC_SING.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UCC_SING.tcl -notrace
