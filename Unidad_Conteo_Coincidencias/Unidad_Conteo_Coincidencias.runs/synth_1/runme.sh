...
HD_PWD='D:/Instrumentacion/Boris FPGA/Unidad_Conteo_Coincidencias/Unidad_Conteo_Coincidencias.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UCC_SING.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UCC_SING.tcl
